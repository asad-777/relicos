...
export default function BaseApp({ title, children, sidebar, toolbar }) {
  return (
    <div className="flex flex-col h-full bg-base-100 text-base-content overflow-hidden rounded-b-xl">
      ...
      {toolbar && (
        <div className="flex-none bg-base-300/50 border-b border-base-content/10 p-2 flex items-center gap-2 shrink-0">
          {toolbar}
        </div>
      )}
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {sidebar && (
          <div className="w-48 sm:w-64 flex-none bg-base-200/50 border-r border-base-content/10 p-4 overflow-y-auto hidden md:block" data-lenis-prevent="true">
            {sidebar}
          </div>
        )}
